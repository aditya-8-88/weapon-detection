# this code is fully functional and it based on pre trained model yolov3 for weapon detection at the time of robbery 
# this model is just trained on weapons so it may assume anything as weapon including weapons off course but if we train it to every possible object then it would recognize every object so at time of weapon detection it would not tell your mobile, watch as weapons.
